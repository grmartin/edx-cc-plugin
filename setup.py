#!/usr/bin/env python
"""
Package metadata for twou_titan_plugin.
"""
import os
import re
import sys
...
setup(
    name='twou_titan_plugin',
    version=VERSION,
    description="""A GetSmarter (Titan) plugin for Commerce Coordinator.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='2U Purchase Squad',
    author_email='gmartin@2u.com',
    url='https://github.com/edx/commerce-coordinator-plugin-titan',
    packages=find_packages(
        include=['twou_titan_plugin', 'twou_titan_plugin.*'],
        exclude=["*tests"],
    ),
