...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd twou_titan_plugin && ../manage.py makemessages -l en -v1 -d django
	cd twou_titan_plugin && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd twou_titan_plugin && ../manage.py compilemessages

detect_changed_source_translations:
	cd twou_titan_plugin && i18n_tool changed
...
dummy_translations: ## generate dummy translation (.po) files
	cd twou_titan_plugin && i18n_tool dummy
