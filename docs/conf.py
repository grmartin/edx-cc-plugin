...
"""
twou_titan_plugin documentation build configuration file.
...
project = 'twou_titan_plugin'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'twou_titan_plugin'
...
#
# html_title = 'twou_titan_plugin v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'A GetSmarter (Titan) plugin for Commerce Coordinator.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'twou_titan_plugin'),
                os.path.join(root_path, 'twou_titan_plugin/migrations')])
